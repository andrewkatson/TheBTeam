...
void CrinkleFry::setUpUnits(){
  ...
  for(int i = 0; i < totalUnits; i++){
    shared_ptr<MeleeUnit> unitToAdd = make_shared<CrinkleFryUnit>(CrinkleFryUnit(crinkleFryHP, crinkleFryDM, crinkleFryAM, crinkleFrySP, crinkleFryAP, crinkleFryAR));
