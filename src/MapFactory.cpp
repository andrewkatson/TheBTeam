...
bool MapFactory::makePath(int pathNumber){
  ...
  while(paths.at(currRowNum).at(currColNum) < 0 || paths.at(currRowNum).at(currColNum) == pathNumber){
      ...
      s << "choose " << exitDirection.intToDirection(expandInto) << endl;
