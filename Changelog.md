...
- Animation for fry units
- Animation and sound effects for fighting between units
...
### Fixed
- compile-time errors in UserView and CompView classes[@jeremyelkayam][https://github.com/jeremyelkayam]
